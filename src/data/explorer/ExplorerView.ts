/// <reference path="../../ui/views/layout/SplitView.ts" />
/**
...
module latte {
    ...
    export class ExplorerView extends SplitView {
        ...
        private detailViewOf(item: ExplorerItem){
            ...
            if(item) {
                // TODO: Temporarily removed delete button
         ...
         */
        private _btnDetailOptions: ButtonItem;
         ...
         * @returns {ButtonItem}
         */
        get btnDetailOptions(): ButtonItem {
            if (!this._btnDetailOptions) {
                let lazy: ButtonItem = this._btnDetailOptions = new ButtonItem(null, LinearIcon.menu);
            }
